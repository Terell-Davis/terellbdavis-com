...
date: 2024-04-21T15:58:00-05:00
categories: ["homelab","technology"]
...
There are two servers that form the backbone of my entire network. It all started with a single server which was an old Compaq computer that came from my grandmother. Later, I upgraded to a system I picked up from MicroCenter for around $200.

A benefit, working at a smaller Managed Service Provider (MSP), was I able to keep a lot of old tech that was either laying around the office or from buisness when there was any decomissionings (Yes I asked). 
...
Down the line I upgraded my gaming setup which left me with some extra parts, so why not build *another* computer so I can lay the poor AMD Athlon to rest.
...
(Yeah I swapped naming schemes by this point) </br>
This is the hub of my data hording habits and recieved thanks to one of those benefits. </br>
